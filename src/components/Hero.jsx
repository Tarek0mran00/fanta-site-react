...
const headphoneData = [
  {
    ...
    title: "Orange Fanta",
    subtitle:
      "Reshreshh with this can of Fanta orange",
    price: "$40",
    modal: "Orange",
    bgColor: "#cf4f00",
  },
  {
    ...
    title: "Fanta Zero",
    subtitle:
      "Reshreshh with this can of Fanta orange zero caloriess",
    price: "$100",
    modal: "Zero",
    bgColor: "#727272",
  },
  {
    ...
    title: "Orange Fanta",
    subtitle:
      "Reshreshh with this bottle of Fanta orange",
    price: "$100",
    modal: "Orange",
    bgColor: "#cf4f00",
  },
                      ...
                      >
                        <div className="flex justify-center">
                          <img
                            src={item.image}
                            alt=""
                            className={`w-[80px] max-h-[300px] img-shadow ${
